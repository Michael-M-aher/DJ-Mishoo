            ...
            cpuStat.usagePercent(function (e, percent, seconds) {
                try {
                    ...
                    const botinfo = new MessageEmbed()
                        ...
                        .addField("💻 Ip", `\`\`${ip.address()}\`\``, true)
                        .addField("API Latency", `\`${client.ws.ping}ms\``, true)
                        .setFooter("Coded by: Mishoo Maher", "https://cdn.discordapp.com/avatars/442355791412854784/a_d5591ce201b3018a7aa06c3f77d4b6f0.gif?size=512");
                    message.reply({
                        embeds: [botinfo]
                    });
